...
class UpconingPatientRegisPage extends StatefulWidget {
  static const String routeName = "/UpconingPatientRegisPage";

  const UpconingPatientRegisPage({super.key});

  @override
  State<UpconingPatientRegisPage> createState() =>
      _UpconingPatientRegisPageState();
}

class _UpconingPatientRegisPageState extends State<UpconingPatientRegisPage> {
  ...
  Future<List<Patient>> fetchPatientData(int doctorId) async {
    final response = await http.get(Uri.parse(
        'http://test.ankusamlogistics.com/doc_reception_api/patient_detail_api/get_uocoming_patient_data_dc_id.php?doctor_id=$doctorId'));
      ...
      children: patients.map((patient) {
        return Row(
          children: [
            ...
            _rowCell(patient.nextVisitingDate.toString(), 2),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Upcoming Patient'),
        actions: [
          Padding(
